$(document).ready(function () {
    ...
    if (whatsappBtn) {
        var whatsappMensaje = '¡Nos casamos! 💍 Entérate de todos los detalles de nuestra boda aquí: ' + window.location.href;
        whatsappBtn.href = 'https://wa.me/?text=' + encodeURIComponent(whatsappMensaje);
    }
